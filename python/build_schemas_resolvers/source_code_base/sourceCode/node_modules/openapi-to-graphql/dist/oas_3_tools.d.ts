...
export declare function isOas2(spec: any): spec is Oas2;
export declare function isOas3(spec: any): spec is Oas3;
/**
 ...
 * parent schema
 */
export declare function resolveAllOf<TSource, TContext, TArgs>(schema: SchemaObject | ReferenceObject, references: {
    [reference: string]: SchemaObject;
}, data: PreprocessingData<TSource, TContext, TArgs>, oas: Oas3): SchemaObject;
/**
