 ...
 */
export declare function getGraphQLType<TSource, TContext, TArgs extends object>({ def, operation, data, iteration, isInputObjectType, fetch }: CreateOrReuseComplexTypeParams<TSource, TContext, TArgs>): GraphQLOutputType | GraphQLInputType;
/**
 * Creates the arguments for resolving a field
 *
 * Arguments that are provided via options will be ignored
 */
export declare function getArgs<TSource, TContext, TArgs extends object>({ requestPayloadDef, parameters, operation, data, fetch }: GetArgsParams<TSource, TContext, TArgs>): Args;
export {};
