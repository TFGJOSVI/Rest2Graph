 ...
 */
export type RequestHeadersFunction<TSource, TContext, TArgs> = (method: string, path: string, title: string, resolverParams?: {
    source: TSource;
    args: TArgs;
    context: TContext;
 ...
 */
export type RequestOptions<TSource, TContext, TArgs> = Omit<RequestInit, 'headers'> & {
