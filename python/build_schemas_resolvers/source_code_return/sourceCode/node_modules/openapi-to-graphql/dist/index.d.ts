 ...
 */
export declare function createGraphQLSchema<TSource, TContext, TArgs extends object>(spec: Oas3 | Oas2 | (Oas3 | Oas2)[], options?: Options<TSource, TContext, TArgs>): Promise<Result<TSource, TContext, TArgs>>;
/**
 * Creates a GraphQL interface from the given OpenAPI Specification 3
 */
export declare function translateOpenAPIToGraphQL<TSource, TContext, TArgs extends object>(oass: Oas3[], { strict, report, operationIdFieldNames, fillEmptyResponses, addLimitArgument, idFormats, selectQueryOrMutationField, genericPayloadArgName, simpleNames, simpleEnumValues, singularNames, createSubscriptionsFromCallbacks, headers, qs, requestOptions, fileUploadOptions, connectOptions, baseUrl, customResolvers, customSubscriptionResolvers, viewer, tokenJSONpath, sendOAuthTokenInQuery, oasValidatorOptions, swagger2OpenAPIOptions, provideErrorExtensions, equivalentToMessages, fetch }: InternalOptions<TSource, TContext, TArgs>): Result<TSource, TContext, TArgs>;
